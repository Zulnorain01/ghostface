#!/usr/bin/env node
/* ============================================================
   GhostFace Studio — Pro license key generator
   ...
   app to unlock watermark-free 2048px exports.

   The checksum algorithm MUST match keyChecksum() in app/app.js.
   NEVER commit generated keys to the repo.
   ============================================================ */
...
for (let n = 0; n < count; n++) {
  ...
  console.log(`GF-${raw.slice(0, 4)}-${raw.slice(4, 8)}-${raw.slice(8, 12)}`);
}
